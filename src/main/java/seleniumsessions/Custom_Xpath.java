...
public class Custom_Xpath {
	...
	public static void main(String[] args) {
		...
		// By help = By.xpath("(//div[@class='navFooterVerticalRow
		// navAccessibility']//a)[last()]");
		...
		// private-form__control login-email']")).sendKeys("test@gmail.com");
...
//		driver.findElement(By.className("login-password")).sendKeys("test@123");
		...
		// invalid - NSE
		// driver.findElement(By.cssSelector("form-control private-form__control
		// login-email")).sendKeys("test@gmail.com");
